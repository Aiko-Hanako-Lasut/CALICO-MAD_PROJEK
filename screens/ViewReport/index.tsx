...
const ReportSummaryScreen = ({navigation}) => {
  const totalPlayers = 23;
  const totalQuestions = 15;
  const quizDuration = '10 minutes';
  const startedEnded = '... - ...'; // Anda bisa menambahkan informasi waktu mulai dan selesai
        ...
        <View style={styles.playersCard}>
          ...
          {playersSummary.map((player, index) => (
            <View
              ...
              <Text style={[styles.cell, {flex: 1}]}>{player.percentage}</Text>
            </View>
          ))}
        </View>
      </ScrollView>
