...
import InputText from '@komponen/TextInput'; // Menggunakan nama InputText
    ...
    <Body>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          <Image
            source={require('@assets/CHAT.png')} // Ganti dengan path ikon chat Anda
        ...
        <Button
          ...
          iconSource={require('@assets/Logout.png')} // Ganti dengan path ikon Anda
