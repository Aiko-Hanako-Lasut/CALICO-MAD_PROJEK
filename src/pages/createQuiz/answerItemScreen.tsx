...
import { switchOff, switchOn } from '../../assets';
...
export interface ControlButtonsPayload { // props (parameter) untuk komponen
  isSave: boolean;
  value: string;
...
const AnswerItemScreen: React.FC<AnswerItemScreenProps> = ({ // komponen utama dengan props
  value,
  isCorrectAnswer,
  ...
  return (
    <View style={styles.overlay}>
      <View style={styles.header}>
        ...
        <Text label={`${text.length} / ${MAX_TEXT_INPUT_LENGTH}`} color="white" size="md" />
      </View>
