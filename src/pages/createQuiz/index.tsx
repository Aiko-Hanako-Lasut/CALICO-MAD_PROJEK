...
import { burger, calicoBg, picture } from '../../assets';
import Button from '../../components/atoms/button';
import HeaderCreateQuiz from '../../components/molecules/header/headerCreateQuiz';
      ...
      <View style={styles.container}>
        ...
        <ImageBackground source={calicoBg} style={styles.background}>
          ...
          <View style={styles.optionRow}>
            ...
            {questions[activeIndex].type === 'Multiple Choice' && <View style={{ flexDirection: 'row', gap: 16}}>
              <AnswerItem
                option='C'
                label={questions[activeIndex].answerList[2] || 'Add answer...'}
                onPress={() => onAnswerPress(2)}
                isCorrectAnswer={questions[activeIndex].correctAnswerIndex === 2}
              />
              <AnswerItem
                option='D'
                label={questions[activeIndex].answerList[3] || 'Add answer...'}
                onPress={() => onAnswerPress(3)}
                isCorrectAnswer={questions[activeIndex].correctAnswerIndex === 3}
              />
            </View>}
        </ImageBackground>
