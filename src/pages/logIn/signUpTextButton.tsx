...
interface SignUpTextButtonProps { // props (parameter) untuk komponen
  onSignUpPress: (event: GestureResponderEvent) => void;
}

const SignUpTextButton: React.FC<SignUpTextButtonProps> = ({ onSignUpPress }) => ( // komponen utama dengan props
