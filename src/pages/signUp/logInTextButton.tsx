...
interface LogInTextButtonProps { // props (parameter) untuk komponen
  onLogInPress: () => void;
}

const LogInTextButton: React.FC<LogInTextButtonProps> = ({ onLogInPress }) => ( // komponen utama dengan props
